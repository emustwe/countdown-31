...
export function ArcadeHeader({
  ...
  return (
    ...
    >
      ...
      <div
        className="arcade-brand absolute left-1/2 top-1 sm:top-2 flex flex-col items-center pointer-events-none z-10"
      ...
      >
        {campaign ? (
          ...
          <div
            onClick={() => router.push("/home")}
            className="standard-game-marquee pointer-events-auto cursor-pointer relative overflow-hidden flex items-center gap-2.5 sm:gap-4 bg-gradient-to-b from-amber-800 via-amber-950 to-black px-3 sm:px-6 py-1.5 sm:py-2.5 rounded-2xl border-2 border-amber-400/90 shadow-[0_8px_26px_rgba(0,0,0,0.85),0_0_28px_rgba(245,158,11,0.55)] hover:brightness-110 active:scale-95 transition-all"
          >
        ...
        {/* Sponsor disclosure only — the game-mode announcement pill was removed per design. */}
        {campaign && (
