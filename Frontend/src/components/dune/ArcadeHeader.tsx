...
export function ArcadeHeader({ onMenuClick, gameMode = "skills", onToggleMode }: ArcadeHeaderProps) {
  ...
  return (
    <header className="relative w-full flex items-start justify-between px-3 sm:px-8 pt-3 pb-2 z-30 select-none h-24 sm:h-28">
      {/* Left Menu Button & Mode Selector Pill */}
      ...
      {/* Center 3D Marquee Banner: COUNT DOWN 31 (Mathematically Locked to Screen 50% Horizontal Center) */}
