  ...
  return (
    <div className="fixed inset-0 pointer-events-none select-none overflow-hidden z-0">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(2,8,5,${config.arena.overlayOpacity}),rgba(2,8,5,.76)),url('${config.arena.backgroundImage}')`,
        }}
      />
      ...
      <div className="absolute -bottom-8 inset-x-0 h-40 opacity-30">
        <svg
          ...
          className="w-full h-full fill-emerald-600/40"
        >
      ...
      <div className="absolute -bottom-14 inset-x-0 h-40 opacity-40">
        <svg
          viewBox="0 0 1440 220"
          preserveAspectRatio="none"
          className="w-full h-full fill-emerald-500/50"
        >
